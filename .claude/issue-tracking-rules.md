...
## 5) Integration with Project Standards

All issues MUST also comply with project rules:
...
6. **NO AI ATTRIBUTION:**
   - NEVER mention AI tools in issues
...
Every line of code committed to any repository MUST be traceable to a GitHub issue. This is non-negotiable for:
- Code quality
- Team collaboration
